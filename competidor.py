...
class Premio:
    ...
    def __init__(self, patrocinador, tipo, fecha_cre, monto, descripcion):
        ...
        self.monto = monto
        self.descripcion = descripcion       if nuevo_score is None:
             self.premios.append(nuevo_premio)
            return 'Dato valido'
...
class Premio:
    ...
    def __init__(self, patrocinador, tipo, fecha_cre, monto, descripcion):
        ...
        self.fecha_cre = fecha_cre
        self.monto = monto
        self.descripcion = descripcion           return 'Dato no valido'
             self.premios.append(nuevo_premio)
            return 'Dato valido'
...
class Premio:
    ...
    def __init__(self, patrocinador, tipo, fecha_cre, monto, descripcion):
        ...
        self.fecha_cre = fecha_cre
        self.monto = monto
        self.descripcion = descripcion       else:
             self.premios.append(nuevo_premio)
            return 'Dato valido'
...
class Premio:
    ...
    def __init__(self, patrocinador, tipo, fecha_cre, monto, descripcion):
        ...
        self.fecha_cre = fecha_cre
        self.monto = monto
        self.descripcion = descripcion           self.scores.append(nuevo_score)
             self.premios.append(nuevo_premio)
            return 'Dato valido'
...
class Premio:
    ...
    def __init__(self, patrocinador, tipo, fecha_cre, monto, descripcion):
        ...
        self.fecha_cre = fecha_cre
        self.monto = monto
        self.descripcion = descripcion           return 'Dato valido'
            self.premios.append(nuevo_premio)
            return 'Dato valido'
...
class Premio:
    ...
    def __init__(self, patrocinador, tipo, fecha_cre, monto, descripcion):
        ...
        self.fecha_cre = fecha_cre
        self.monto = monto
        self.descripcion = descripcion   def aniadir_premio(self, nuevo_premio):
             self.premios.append(nuevo_premio)
            return 'Dato valido'
...
class Premio:
    ...
    def __init__(self, patrocinador, tipo, fecha_cre, monto, descripcion):
        ...
        self.fecha_cre = fecha_cre
        self.monto = monto
        self.descripcion = descripcion       if nuevo_premio is None:
             self.premios.append(nuevo_premio)
            return 'Dato valido'
