...
**[Travis](https://travis-ci.org)** Permite instalar todas las dependencias y ejecutar los test (desarrollados con unitTest) de manera automatica en cada actualización realizada sobre nuestro repositorio github. Tambien permite comprobar el funcionamiento correcto de nuestros tests en diversas versiones de Python. En su archivo de configuración le indicamos los comandos make a ejecutar tanto para instalación como para los test de validación.  
...
4. Crear y subir al repositorio el archivo de configuración [.travis.yml](https://github.com/rodrigo-orellana/eco-challenge/blob/master/.travis.yml). En este archivo posee la estructura *language* en donde indicamos python, luego en *python* indicamos las versiones, en *install* indicamos el comando buildtool make el cual instala las dependencias, en *services* los servicios utilizados, en este caso mongodb. en *env* creamos una variable de ambiente que será util para que los test identifiquen donde se están ejecutando. finalmente en *script* indicamos las líneas de comando para ejecucción de los test.
...
3. Crear y subir al repositorio el archivo de configuración [.circleci/config.yml](https://github.com/rodrigo-orellana/eco-challenge/blob/master/.circleci/config.yml). Este archivo de configuración posee el lenguaje del proyecto, la versión del lenguaje, los comandos para crear la virtualización de dicho lenguaje, comando de instalación de dependencias y de ejecucción de test.
Más información ver la [documentación](https://github.com/rodrigo-orellana/eco-challenge/blob/master/docs/integracion_continua.md)
